...
var app = {
  ...
  _mutationsTypes.PLAY_NEXT, function (_ref2) {var dispatch = _ref2.dispatch,state = _ref2.state;var
  ...
  _mutationsTypes.PLAY_PREV, function (_ref3) {var dispatch = _ref3.dispatch,state = _ref3.state;var
    currentMusic = state.currentMusic,currentMusicList = state.currentMusicList;
    if (currentMusic.id) {
      var index = currentMusicList.findIndex(function (item) {return item.id === currentMusic.id;});
      if (index > 0) {
...
var apis = {
  // 搜索歌曲列表
  cloudSearch: function cloudSearch(data) {return request('/cloudsearch', 'post', data);} };
...
var music = {
  // 获取播放地址
  getMusicUrl: function getMusicUrl(data) {return (0, _request.default)('/song/url', 'post', data);} };var _default =
