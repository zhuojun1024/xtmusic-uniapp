...
var _app = _interopRequireDefault(__webpack_require__(/*! ./modules/app.js */ 12));
var _playControl = _interopRequireDefault(__webpack_require__(/*! ./modules/playControl.js */ 16));
...
var store = new _vuex.default.Store({
  modules: {
    app: _app.default,
    playControl: _playControl.default },
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _login = _interopRequireDefault(__webpack_require__(/*! @/api/login.js */ 13));
var _mutationsTypes = __webpack_require__(/*! ../mutations-types.js */ 15);var _mutations;function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var login = {
  // 登录
  loginCellPhone: function loginCellPhone(data) {return (0, _request.default)('/login/cellphone', 'post', data);},
  // 获取登录用户信息
  getAccountInfo: function getAccountInfo(data) {return (0, _request.default)('/user/account', 'post', data);},
  // 注销登录
  logout: function logout(data) {return (0, _request.default)('/logout', 'post', data);} };var _default =
...
/***/ 14:
/*!**************************************************************************************!*\
  !*** C:/Users/SYN-ZJ-021/Documents/HBuilderProjects/xtmusic-uniapp/request/index.js ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(uni) {function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;} // 小程序开发api接口统一配置
var subDomain = '/api'; // 子域名
var API_BASE_URL = 'https://www.i4896.com'; // 主域名

var request = function request(url, method, data) {
  var _url = API_BASE_URL + subDomain + url;
  ...
  return new Promise(function (resolve, reject) {
    uni.request({
      ...
      success: function success(request) {var _request$data =
        request.data,code = _request$data.code,status = _request$data.status,msg = _request$data.msg,message = _request$data.message;
...
/***/ 16:
/*!**************************************************************************************************!*\
  !*** C:/Users/SYN-ZJ-021/Documents/HBuilderProjects/xtmusic-uniapp/store/modules/playControl.js ***!
  \**************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _music = _interopRequireDefault(__webpack_require__(/*! @/api/music.js */ 9));
var _mutationsTypes = __webpack_require__(/*! ../mutations-types.js */ 15);var _mutations, _actions;function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var app = {
  ...
  _mutationsTypes.SET_CURRENT_MUSIC, function (state, value) {
    state.currentMusic = value;
  }), _defineProperty(_mutations,

  _mutationsTypes.SET_CURRENT_MUSIC_LIST, function (state, value) {
  ...
  _mutationsTypes.TIME_UPDATE, function (state, value) {
    state.currentTime = value;
  }), _defineProperty(_mutations,

  _mutationsTypes.SET_DURATION, function (state, value) {
    state.duration = value;
  }), _defineProperty(_mutations,

  _mutationsTypes.SET_PAUSED, function (state, value) {
    state.paused = value;
  }), _defineProperty(_mutations,

  _mutationsTypes.PLAY_PAUSE, function (state) {var
    bam = state.bam,currentMusic = state.currentMusic;
    if (currentMusic.id) {
  ...
  _mutationsTypes.SET_CURRENT_MUSIC, function (_ref, currentMusic) {var commit = _ref.commit,state = _ref.state;
    ...
    return _music.default.getMusicUrl(params).then(function (res) {
      ...
      if (res.data && res.data.length) {
        ...
        var bam = state.bam;var

        name = currentMusic.name,ar = currentMusic.ar,al = currentMusic.al;
        bam.title = name;
        bam.singer = ar;
  ...
  _mutationsTypes.PLAY_NEXT, function (_ref2) {var dispatch = _ref2.dispatch,commit = _ref2.commit,state = _ref2.state;var
    currentMusic = state.currentMusic,currentMusicList = state.currentMusicList,shuffleMusicList = state.shuffleMusicList,playMode = state.playMode;
    // 判断是否随机播放模式，是的话使用随机列表
    var musicList = playMode === _mutationsTypes.PLAY_MODE_SHUFFLE ? shuffleMusicList : currentMusicList;
    if (currentMusic.id) {
      var index = musicList.findIndex(function (item) {return item.id === currentMusic.id;});
      var nextMusic;
      // 是否还有下一首，没有取第一首
      ...
      // 如果有版权则播放否则继续跳到下一首
      if (nextMusic.st !== -200) {
        return dispatch(_mutationsTypes.SET_CURRENT_MUSIC, nextMusic);
      } else {
        commit(_mutationsTypes.SET_CURRENT_MUSIC, nextMusic);
        return dispatch(_mutationsTypes.PLAY_NEXT, nextMusic);
      }
    }
  }), _defineProperty(_actions,

  _mutationsTypes.PLAY_PREV, function (_ref3) {var dispatch = _ref3.dispatch,commit = _ref3.commit,state = _ref3.state;var
    currentMusic = state.currentMusic,currentMusicList = state.currentMusicList,shuffleMusicList = state.shuffleMusicList,playMode = state.playMode;
    // 判断是否随机播放模式，是的话使用随机列表
    var musicList = playMode === _mutationsTypes.PLAY_MODE_SHUFFLE ? shuffleMusicList : currentMusicList;
    if (currentMusic.id) {
      ...
      // 如果有版权则播放否则继续跳到上一首
      if (lastMusic.st !== -200) {
        return dispatch(_mutationsTypes.SET_CURRENT_MUSIC, lastMusic);
      } else {
        commit(_mutationsTypes.SET_CURRENT_MUSIC, lastMusic);
        return dispatch(_mutationsTypes.PLAY_PREV, lastMusic);
      }
    }
  }), _defineProperty(_actions,

  _mutationsTypes.ON_ENDED, function (_ref4) {var dispatch = _ref4.dispatch,state = _ref4.state;
    // 是否为单曲循环模式
    if (state.playMode === _mutationsTypes.PLAY_MODE_REPEAT_ONE) {
      return dispatch(_mutationsTypes.SET_CURRENT_MUSIC, state.currentMusic);
    } else {
      return dispatch(_mutationsTypes.PLAY_NEXT);
    }
  }), _actions) };var _default =
...
/***/ 17:
/*!**************************************************************************************!*\
  !*** C:/Users/SYN-ZJ-021/Documents/HBuilderProjects/xtmusic-uniapp/store/getters.js ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var getters = {
  ...
  currentMusic: function currentMusic(state) {return state.playControl.currentMusic;},
  currentMusicList: function currentMusicList(state) {return state.playControl.currentMusicList;},
  currentTime: function currentTime(state) {return state.playControl.currentTime;},
  duration: function duration(state) {return state.playControl.duration;},
  paused: function paused(state) {return state.playControl.paused;},
  bam: function bam(state) {return state.playControl.bam;},
...
/***/ 185:
/*!************************************************************************************************!*\
  !*** C:/Users/SYN-ZJ-021/Documents/HBuilderProjects/xtmusic-uniapp/pages.json?{"type":"stat"} ***!
  \************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__05E4911" };exports.default = _default;
...
{ hex_md5: hex_md5, b64_md5: b64_md5, str_md5: str_md5, hex_hmac_md5: hex_hmac_md5, b64_hmac_md5: b64_hmac_md5, str_hmac_md5: str_hmac_md5 };exports.default = _default;

/***/ }),

/***/ 36:
/*!****************************************************************************************!*\
  !*** C:/Users/SYN-ZJ-021/Documents/HBuilderProjects/xtmusic-uniapp/pages/login/api.js ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var apis = {
  // 获取验证码
  sendCaptcha: function sendCaptcha(data) {return request('/captcha/sent', 'post', data);} };
...
/***/ 45:
/*!*****************************************************************************************!*\
  !*** C:/Users/SYN-ZJ-021/Documents/HBuilderProjects/xtmusic-uniapp/pages/search/api.js ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var apis = {
  // 搜索热词
  getHotDetail: function getHotDetail(data) {return (0, _request.default)('/search/hot/detail', 'post', data);},
  // 搜索建议
  getSearchSuggest: function getSearchSuggest(data) {return (0, _request.default)('/search/suggest', 'post', data);} };var _default =
...
/***/ 5:
/*!********************************************************************************!*\
  !*** C:/Users/SYN-ZJ-021/Documents/HBuilderProjects/xtmusic-uniapp/pages.json ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.formatTime = formatTime;function formatTime(sec) {
  var _sec = Math.ceil(sec || 0);
  var m = parseInt(_sec / 60);
  var s = _sec % 60;
...
/***/ 9:
/*!**********************************************************************************!*\
  !*** C:/Users/SYN-ZJ-021/Documents/HBuilderProjects/xtmusic-uniapp/api/music.js ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _index = _interopRequireDefault(__webpack_require__(/*! @/store/index.js */ 10));
