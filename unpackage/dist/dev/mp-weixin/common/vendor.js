...
var app = {
  ...
  _mutationsTypes.PLAY_NEXT, function (_ref2) {var dispatch = _ref2.dispatch,commit = _ref2.commit,state = _ref2.state;var
    currentMusic = state.currentMusic,currentMusicList = state.currentMusicList;
    if (currentMusic.id) {
      var index = currentMusicList.findIndex(function (item) {return item.id === currentMusic.id;});
      if (index < currentMusicList.length - 1) {
        var nextMusic = currentMusicList[index + 1];
        // 如果有版权则播放否则继续跳到下一首
        if (nextMusic.st !== -200) {
  ...
  _mutationsTypes.PLAY_PREV, function (_ref3) {var dispatch = _ref3.dispatch,commit = _ref3.commit,state = _ref3.state;var
    ...
    if (currentMusic.id) {
      var index = currentMusicList.findIndex(function (item) {return item.id === currentMusic.id;});
      if (index > 0) {
        var lastMusic = currentMusicList[index - 1];
        // 如果有版权则播放否则继续跳到上一首
        if (lastMusic.st !== -200) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var getters = {
  ...
  toneQuality: function toneQuality(state) {return state.playControl.toneQuality;} };var _default =
